        ...
        <Row>
          <Col xs={12} lg={6}>
              <Form.Group>
                  ...
                  <Form.Control maxLength={maxInputLength} id="fedit-height" type="text" value={cfieldobj?cfieldobj.masterFieldHeight:0} onChange={(e) => handlemaindim(e,"masterFieldHeight")} style={{fontWeight:"700",color:"#dc3545"}}/>
              </Form.Group>
          </Col>
        </Row>
                  ...
                  <React.Fragment key={idx}>
                    ...
                    <div className="NDUrackparams">
                        <Row className="NDUshelfdetails">
                            ...
                            {/* <Col xs={3} style={{padding:"0px"}}> <FormSelect value={shelf.reverseRowNumber}
                            ...
                            <Col style={{maxWidth:"25%"}} className="NDUrowvalue"><Form.Control maxLength={maxInputLength} type="text" className="feditrow-width" size="sm" value={shelf.width}
                                onChange={e => handleShelfChange(e,idx,"width")} disabled/></Col>
                            <Col style={{maxWidth:"25%"}} className="NDUrowvalue"><Form.Control maxLength={maxInputLength} type="text" className="feditrow-height" size="sm" value={shelf.height}
                                onChange={e => handleShelfChange(e,idx,"height")}/></Col>
                            <Col style={{maxWidth:"25%"}} className="NDUrowvalue"><Form.Control maxLength={maxInputLength} type="text" className="feditrow-gap" size="sm" value={shelf.gap}
